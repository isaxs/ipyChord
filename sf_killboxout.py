...
def sf_killboxout(img,log=None,grey=None,zoom=1.2):
    """
    This function is used to kill the outside part of the box.
    """
    ...
    tmp['map'][ss[1]:ss[1]+ss[3]+1,ss[0]:ss[0]+ss[2]+1]=0.0
    res['map']=np.zeros((res['height'],res['width']),dtype=np.float)
    res['map'][ss[1]:ss[1]+ss[3]+1,ss[0]:ss[0]+ss[2]+1]=1.0
    return res,tmp
